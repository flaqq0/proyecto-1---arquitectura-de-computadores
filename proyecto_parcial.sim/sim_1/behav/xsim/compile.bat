...
REM
REM Generated by Vivado on Mon Oct 20 10:32:30 -0500 2025
...
echo "xvlog --incr --relax -prj tb_falu_vlog.prj"
call xvlog  --incr --relax -prj tb_falu_vlog.prj -log xvlog.log
