...
REM
REM Generated by Vivado on Fri Oct 17 03:43:28 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fsub_vlog.prj"
call xvlog  --incr --relax -prj tb_fsub_vlog.prj -log xvlog.log
