...
REM
REM Generated by Vivado on Wed Oct 15 16:45:09 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fadd_vlog.prj"
call xvlog  --incr --relax -prj tb_fadd_vlog.prj -log xvlog.log
