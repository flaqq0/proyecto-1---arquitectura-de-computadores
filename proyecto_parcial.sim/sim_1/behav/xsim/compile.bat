...
REM
REM Generated by Vivado on Fri Oct 17 13:39:30 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fdiv_vlog.prj"
call xvlog  --incr --relax -prj tb_fdiv_vlog.prj -log xvlog.log
